INTERFACE zif_zabap_table_edit_data PUBLIC.
  METHODS:
    ...
    additional_validation DEFAULT IGNORE CHANGING result TYPE i all_modified_data TYPE REF TO data compared TYPE zcl_zabap_table_edit_globals=>t_data_comparision,
    ...
    before_save DEFAULT IGNORE CHANGING compared TYPE zcl_zabap_table_edit_globals=>t_data_comparision,
